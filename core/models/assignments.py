...
class Assignment(db.Model):
    ...
    def mark_grade(cls, _id, grade, auth_principal: AuthPrincipal):
        ...
        if auth_principal.principal_id:
            assertions.assert_valid( assignment.state == AssignmentStateEnum.SUBMITTED or assignment.state == AssignmentStateEnum.GRADED, 'only a submitted or graded assignment can be graded by principal')
        else:
